...
export const MODELS: ModelNode[] = [
  ...
  { id: "llama",    name: "GPT-OSS 120B",     role: "The Guardian",     nature: "Protective · Active · Reliable", status: "standby", color: "#FF5A5A", x: -22, y: 30,
    provider: "Groq", speed: 92, context: "128K", purpose: "General fallback — always on", cost: "free", priority: 4 },
  { id: "llama8b",  name: "GPT-OSS 20B",      role: "The Archivist",    nature: "Silent · Stable · Instant",   status: "standby", color: "#E6E6FF", x: -40, y: -20,
